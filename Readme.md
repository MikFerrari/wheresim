...
Wheresim is a reduced version of Locosim didactic framework for the WHERE summer school to learn/test basic controllers schemes on quadruped robots. Wheresim has been successfully tested on Aliengo and Go1, Go2 robots. 

Wheresim is composed by a **roscontrol** node called **ros_impedance_controller** (written in C++) that interfaces a python ROS node (where the controller is written) to a Gazebo simulator. 

You have 2 ways to get the Wheresim code:  1) with docker (recommended) 2) by manual installation of dependencies.

**Note**: If you intend to use Wheresim for your *research* please cite:
...
**LINUX**: follow this  [procedure](https://github.com/idra-lab/wheresim/blob/master/install_docker_linux.md).

**MAC:** follow this  [procedure](https://github.com/idra-lab/wheresim/blob/master/install_docker_mac.md).

**WINDOWS:** follow this [procedure](https://github.com/idra-lab/wheresim/blob/master/install_docker_windows.md).



# Native Installation 

**LINUX:** follow this [procedure](https://github.com/idra-lab/wheresim/blob/master/install_native.md).

**MAC:** follow this [procedure](https://github.com/idra-lab/wheresim/blob/master/install_native.md), just replace **"sudo apt install package_name"** with **"brew install package_name"**.
...
then follow this [procedure](https://github.com/idra-lab/wheresim/blob/master/install_native.md).
...
4. click "Open File or Project" and open the folder robot_control. Then launch **wheresim/robot_control/base_controllers/quadruped_controller.py**      right click on the code and selecting "Run File in Pyhton Console"
...
```
$ python3 -i $LOCOSIM_DIR/robot_control/base_controllers/quadruped_controller.py
```
